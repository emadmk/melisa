...
const mockBackups = [
  {
    id: '1',
    filename: 'backup_1402-10-15_14-30.sql',
    size: '۱۲.۵ مگابایت',
  ...
  {
    id: '2',
    filename: 'backup_1402-10-14_14-30.sql',
    size: '۱۲.۳ مگابایت',
    createdAt: '۱۴۰۲/۱۰/۱۴ - ۱۴:۳۰',
    type: 'auto',
    status: 'success',
  },
  {
    id: '3',
    filename: 'backup_1402-10-13_10-00.sql',
    size: '۱۲.۱ مگابایت',
    createdAt: '۱۴۰۲/۱۰/۱۳ - ۱۰:۰۰',
    type: 'manual',
    status: 'success',
  },
]
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-dark">پشتیبان‌گیری</h1>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="font-bold text-dark mb-2">ایجاد پشتیبان</h2>
              <p className="text-sm text-gray-500 mb-4">
                یک نسخه پشتیبان از تمام اطلاعات سایت ایجاد کنید
              </p>
              <button
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="font-bold text-dark mb-2">بازیابی پشتیبان</h2>
              <p className="text-sm text-gray-500 mb-4">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
        <h2 className="font-bold text-dark mb-4">تنظیمات پشتیبان‌گیری خودکار</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
              <option value="7">۷ نسخه</option>
              <option value="14">۱۴ نسخه</option>
              <option value="30">۳۰ نسخه</option>
            </select>
          </div>
        </div>
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg flex items-start gap-3">
          ...
          <div className="text-sm">
            <p className="text-blue-700 font-medium">پشتیبان‌گیری بعدی</p>
            <p className="text-blue-600">فردا ساعت ۱۴:۳۰</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <div className="p-6 border-b">
          <h2 className="font-bold text-dark">تاریخچه پشتیبان‌ها</h2>
        </div>
